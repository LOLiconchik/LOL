...
<main class="page-main">
	...
	<section class="to-mail">
		<div class="to-mail-h">
			<div class="header-to-mail">
				<h3>Get In Toch</h3>
			</div>
			<form action="/php/send.php" method="post">
				<input type="text" id="your-name" name="your_name" placeholder="Your Name">
				<input type="email" id="email" name="email" placeholder="Your Email">
				<textarea name="textmessage" id="Your Message" cols="100" rows="50" placeholder="Your Message"></textarea>
				<div class="sent-mail">
